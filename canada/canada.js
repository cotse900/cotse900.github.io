document.addEventListener("DOMContentLoaded", function () {
      ...
      provinces.forEach((province) => {
        ...
        province.addEventListener("click", function () {
          ...
          totalMarks = totalMarks - currentMarks + parseInt(this.getAttribute("data-marks"));
      ...
      function updateLanguage(lang) {
        const elementsWithLangAttribute = document.querySelectorAll("[data-lang-en], [data-lang-fr], [data-lang-zh]");
